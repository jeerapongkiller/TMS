    ...
    <div class="navbar-container d-flex content">
        ...
        <ul class="nav navbar-nav align-items-center ml-auto">
                ...
                <li class="nav-item dropdown dropdown-user"><a class="nav-link dropdown-toggle dropdown-user-link" id="dropdown-user" href="javascript:void(0);" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <div class="user-nav d-sm-flex d-none"><span class="user-name font-weight-bolder"> <?php echo $_SESSION["admin"]["name"]; ?> </span><span class="user-status"> <?php echo $_SESSION["admin"]["permission_name"]; ?> </span></div><span class="avatar"><img class="round" src="inc/photo/users/<?php echo $_SESSION["admin"]["photo"]; ?>" alt="avatar" height="40" width="40"><span class="avatar-status-online"></span></span>
                    </a>
